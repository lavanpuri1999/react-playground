...
describe('ModalButton Component', () => {
  ...
  test('closes the modal when the modal overlay is clicked', () => {
    render(<ModalButton />);
    const openButton = screen.getByText('Open Modal');
    fireEvent.click(openButton);
  ...
  test('renders the component with data-testid attribute', () => {
    render(<ModalButton />);
    const component = screen.getByTestId('modalbutton-component');
